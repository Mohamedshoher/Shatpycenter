...
export default function TeacherCollectionsModal({
    ...
    return (
        <>
            ...
            <SlideIn show={isOpen} className="fixed inset-4 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-[600px] h-fit max-h-[90vh] bg-white rounded-[40px] shadow-2xl z-[101] overflow-hidden flex flex-col border border-gray-100">
                {/* Header */}
