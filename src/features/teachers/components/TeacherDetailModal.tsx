...
مركز الشاطبي
    ...
    return (
        <>
            ...
            >
                <div className="bg-white rounded-[40px] md:rounded-[56px] shadow-2xl overflow-hidden flex flex-col border border-white/20 w-full max-w-full md:max-w-7xl h-[90vh] md:h-[90vh]">
                    {/* رأس النافذة (Header) */}
