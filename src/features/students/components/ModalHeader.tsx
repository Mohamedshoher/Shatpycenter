        ...
        <div className="p-5 relative border-b border-gray-50">
            ...
            <div className="text-right mt-2 md:mt-0">
                ...
                <div className="flex items-center justify-end gap-3 flex-wrap">
                    ...
                    {/* شارة أزهري */}
                    {azhariInfo.isAzhari && (
                        <span className="text-red-600 font-bold text-sm bg-red-50 border border-red-200 px-3 py-1.5 rounded-lg flex items-center gap-1.5">
                            <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse" />
                            <span>أزهري {azhariInfo.azhariGrade ? `(${azhariInfo.azhariGrade})` : ''}</span>
                        </span>
                    )}
