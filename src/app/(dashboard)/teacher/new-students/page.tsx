...
import { getStudentAzhariInfo } from '@/features/students/constants/azharCurriculum';
                                ...
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                                            ...
                                            {azhariInfo.isAzhari && (
                                                <span className="inline-flex items-center gap-1 text-[11px] font-bold text-red-600 bg-red-50 border border-red-200/80 px-2.5 py-0.5 rounded-full">
                                                    أزهري {azhariInfo.azhariGrade ? `(${azhariInfo.azhariGrade})` : ''}
                                                </span>
                                            )}
