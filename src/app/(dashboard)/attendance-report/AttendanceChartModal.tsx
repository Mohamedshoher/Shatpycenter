...
export default function AttendanceChartModal({ isOpen, onClose, title, type, data = [] }: AttendanceChartModalProps) {
    ...
    return (
        <>
            ...
            <SlideIn show={isOpen} className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                <div className="relative bg-white w-[95vw] max-w-4xl h-[85vh] rounded-[30px] shadow-2xl z-[201] overflow-hidden flex flex-col text-right">
                                        ...
                                        <div key={index} className="flex flex-col gap-2 group">
                                            ...
                                            <div className="h-3 w-full bg-gray-100 rounded-full overflow-hidden shadow-inner">
                                                <div style={{ width: `${widthPercentage}%` }}
                                                    className={cn(
                                                        "h-full rounded-full relative animate-[chartFill_0.7s_ease-out]",
